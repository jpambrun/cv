...
\begin{cvfootnote}
  \engfr{\textdagger~ not a member of the OIQ\\\textdaggerdbl~ allows doctoral  admission without obtaining the master's degree }{\textdagger~ non membre de l'OIQ\\\textdaggerdbl~ permet le passage au doctorat sans obtenir le grade de maîtrise}
\end{cvfootnote}
% \section{interests}
