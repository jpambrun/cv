...
\begin{entrylist}
  \engfr
  {\entry {jun. 2016-} {postdoctoral fellow} {CHUM research centre} {\emph{MR-TRUS fusion and segmentation using deep neural networks}}}
  {\entry {juin 2016-} {stagiaire postdoctoral} {Centre de recherche du CHUM} {\emph{fusion et segmentation IRM-TRUS à l'aide de l'apprentissage profond}}}

  \engfr
  {\entry {sept. 2016-} {lecturer} {École Polytechnique de Montréal} {\emph{procedural programming (\infmat)}}}
  {\entry {sept. 2016-} {chargé de cours} {École Polytechnique de Montréal} {\emph{programmation procédurale (\infmat)}}}
