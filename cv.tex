...
\begin{cvfootnote}
  \engfr{\textdagger~ not a member of the OIQ\\\textdaggerdbl~ allows doctoral  admission without obtaining the master's degree }{\textdagger~ pas membre de l'OIQ\\\textdaggerdbl~ permet le passage au doctorat sans obtenir le grade de maîtrise}
\end{cvfootnote}
% \section{interests}
...
\begin{entrylist}
  ...
  \engfr
  {\entry {2009-2010} {M.Sc. in electrical engineering (fast-track\textsuperscript{\tiny\textdaggerdbl})} {École de technologie supérieure {\scriptsize (ÉTS)}} {\emph{evaluating the diagnostic quality of lossy compressed images}}}
  {\entry {2009-2010} {M.Sc. en génie électrique (passage acéléré\textsuperscript{\tiny\textdaggerdbl})} {École de technologie supérieure {\scriptsize (ÉTS)}} {\emph{évaluation des pertes liées à la compression d'images médicales}}}
